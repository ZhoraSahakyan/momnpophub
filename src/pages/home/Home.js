                ...
                <div className="row flex-column-reverse flex-md-row">
                    <section className="col-md-6">
                        ...
                        <Form className="login-form">
                            ...
                            <CheckboxContainer labetText="We are an online business only"/>
                            <Form.Group>
                                <Form.Control type="text" className="input shadow-none"
                            ...
                            <Button variant="btn" className="red-btn" type="submit">
                                Signup for FREE
                            </Button>
                        </Form>
                    </section>
                    <section className="col-md-6">
                        <h2 className="general-title">Frequently Asked Questions by Small Business Owners like
                            yourself</h2>
            ...
            <section className="col-lg-9 col-md-12 col-sm-7 mx-auto ">
                ...
                <div className="view-container">
                    <figure className="view-item text-center text-center">
                        <img src={dsfImage} className="view-item__image" alt=""/>
                    ...
                    <figure className="view-item text-center text-center">
                        <img src={networkImage} className="view-item__image" alt=""/>
                        <figcaption className="view-item__name text-decoration-none">Simplify customer
                            acquisition
                    ...
                    <figure className="view-item text-center text-center">
                        <img src={XMLIDImage} className="view-item__image" alt=""/>
                        <figcaption className="view-item__name text-decoration-none">Simplify customer
                            acquisition
                        ...
                        <ul className="steps list-unstyled pl-0">
                            <li className="steps__item">
                                <div>
                                    ...
                                    <p className="steps__item__desc">Signup your Small Business with our platform and
                            ...
                            <li className="steps__item mb-0">
                                <div>
                                    ...
                                    <p className="steps__item__desc">Your business starts getting new customers and you
            ...
            <div className="contact-container">
                <section className="col-lg-6  mx-auto ">
                    ...
                    <p className="text-center contact-description">
                        Please feel free to send your questions to <a href="mailTo:contact@momnpophub.com.">contact@momnpophub.com.</a>
                        <br/>
