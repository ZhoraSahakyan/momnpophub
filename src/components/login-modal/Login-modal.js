...
const LoginModal = ({ show, disabled, handleShow, handleClose, setDisabled }) => {
            ...
            <Modal show={show} className="login-modal" onHide={handleClose}>
                ...
                <Modal.Body>
                    ...
                    <Form className="login-form">
                        ...
                        <Button variant="btn" className="red-btn w-100" type="button" onClick={() => {handleClose(); setDisabled(true)}}>
                            Log in
                        </Button>
                    </Form>
                </Modal.Body>
