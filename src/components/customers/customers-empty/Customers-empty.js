     ...
     {/*<AlertBlock/>*/}
            ...
            <div className="position-absolute arrow-line d-flex flex-column align-items-end">
                <svg  width="181" height="386" viewBox="0 0 181 386" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M164.5 385C177.009 351.452 189.745 230.632 169.5 159.5C151 94.5 110.002 52.285 63.0438 20.7869M57 6.5C61.0438 12.1825 64 9.84127 63.0438 20.7869M63.0438 20.7869C46.6986 17.4086 15 20.7869 5 6.5" stroke="black" strokeOpacity="0.42" strokeDasharray="8 8"/>
                </svg>
            </div>
